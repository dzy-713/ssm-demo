...
<%--</div>--%>
<shiro:hasPermission name="burn-edit">
    ...
    function reload() {
        layui.use('table', function () {
            ...
            var option={
                ...
                data: [],    //加载静态数据
                url: '/api/burn/list?barcode='+$("#barcode").val(), //数据接口
                ...
                cols: [[        //表头
                    ...
                    // {field: 'workOrderNum', title: '工单号'},
                    // {field: 'partNum', title: '成品料号'},
                    {field: 'testTime', title: '测试时间',templet:'<div>{{ layui.util.toDateString(d.testTime, "yyyy-MM-dd HH:mm:ss") }}</div>'},
                    {field: 'adc0', title: 'ADC0'},
                    {field: 'adc10_15', title: 'ADC10_15'},
                    {field: 'adc350', title: 'ADC350'},
                    {field: 'maxCodes', title: 'MaxCodes'},

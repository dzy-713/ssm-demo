...
<div class="layui-row">
    <div class="layui-btn-group layui-col-xs6">
        <button class="layui-btn" onclick="openEditPage('/user/edit.do','460px','800px')"><i
        ...
        layui.use('table', function () {
            ...
            table.render({
                ...
                cols: [[        //表头
                    ...
                    {field: 'allowLogin', title: '允许登陆' ,templet:'#titleTpl-allowLogin'},
            ...
            //监听登陆权限操作
            form.on('switch(allowLogin)', function(obj){
...
<%--指定显示模板--%>
<script type="text/html" id="titleTpl-allowLogin">
    <input type="checkbox" name="allowLogin" value="{{d.allowLogin}}"
           lay-skin="switch" lay-text="允许|禁止" lay-filter="allowLogin" readonly
           {{ (d.allowLogin == true)?'checked':'' }} disabled/>
</script>
<%--绑定工具组件--%>
<script type="text/html" id="toolbar">
    <a class="layui-btn layui-btn-xs" lay-event="edit"
       onclick="openEditPage('/user/edit.do?id={{d.id}}','460px','800px')">编辑</a>

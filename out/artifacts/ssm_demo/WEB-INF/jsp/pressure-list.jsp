...
<%--</div>--%>
<shiro:hasPermission name="pressure-edit">
    ...
    function reload() {
        layui.use('table', function () {
            ...
            var option={
                ...
                data: [],    //加载静态数据
                url: '/api/pressure/list?barcode='+$("#barcode").val(), //数据接口
                ...
                cols: [[        //表头
                    ...
                    {field: 'barcode', title: '条码',rowspan: 2},
                    {field: 'worker', title: '工号',rowspan: 2},
                    {field: 'testTime', title: '测试时间',templet:'<div>{{ layui.util.toDateString(d.testTime, "yyyy-MM-dd HH:mm:ss") }}</div>' ,rowspan: 2},
                    {align: 'center', title: 'Ag', colspan: 3},
                    {align: 'center', title: 'Bg', colspan: 3},
                    {align: 'center', title: 'Cg', colspan: 3},
                    {field: 'station', title: '工站',rowspan: 2},
                    {field: 'pass', title: '测试通过',rowspan: 2}
                ],[
                    {field: 'agWeight', title: '重量'},
                    {field: 'agTestResult', title: '测试结果'},
                    {field: 'agAvgPressure', title: '压力'},
                    {field: 'bgWeight', title: '重量'},
                    {field: 'bgTestResult', title: '测试结果'},
                    {field: 'bgAvgPressure', title: '压力'},
                    {field: 'cgWeight', title: '重量'},
                    {field: 'cgTestResult', title: '测试结果'},
                    {field: 'cgAvgPressure', title: '压力'}

                ]]
            };
            //编辑权限
            if($("#editPermission").length>0){
                option.cols[0].push({field: 'toolbar', title: '操作', toolbar: '#toolbar',rowspan: 2});
            }
            //第一个实例
            table.render(option);

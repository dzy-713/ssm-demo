    ...
    function reload() {
        layui.use('table', function () {
            ...
            var option={
                ...
                data: [],    //加载静态数据
                url: '/api/fun/list?barcode='+$("#barcode").val(), //数据接口
                ...
                cols: [[        //表头
                    ...
                    {field: 'drawLineTest', title: '划线测试'},
                    {field: 'leakWaterTest', title: '漏水测试'},
                    {field: 'upBtnTest', title: '上按键测试'},
                    {field: 'downBtnTest', title: '下按键测试'},
